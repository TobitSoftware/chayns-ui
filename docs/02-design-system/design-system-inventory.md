...
| Banner | CONFIRMED CHAYNS UI CLARIFICATION | Bodywork zeigt Banner als vollbreite Statusfläche mit Icon, flexiblem Inhalt und Close-Affordance. chayns UI führt dafür ein eigenständiges `Banner`; MessageBox bleibt statischer erklärender Kontext. | DesignSystem: „Status & Meldungen“ → „Banner“, `#status`; MESSAGE-004 |
