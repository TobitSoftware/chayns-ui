...
| Badges and Chips | CONFIRMED CHAYNS UI CLARIFICATION | Bodywork trennt Status-Badge, Count-Badge, Reaktions-Chip, Tag und Verify-Badge. Status-Badges sitzen auf einem Element und sind keine Buttons; Tags und Chips tragen bei entfernbaren Inhalten eine eigene Remove-Aktion. chayns UI führt dafür eine Badge mit bestätigter optionaler Remove-API. | DesignSystem: „Status & Meldungen“ → „Badges & Chips“, `#status`, `tobit-ds.css`; BADGE-001–002 |
