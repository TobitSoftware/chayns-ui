...
Resolved chayns UI baseline, color and patch CSS plus an SSR-safe accent-color resolver.

```ts
import { resolveThemeColors } from '@chayns-ui/tokens';
...
returns the mode-specific accent, hover and active CSS variables.
